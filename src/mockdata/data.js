const data = {
  en: {
    ...
    aboutMeText:
      "After working in my main branch for three years, I thought that I could use my individual talents more effectively in the software industry. I am excited about the job opportunities I can find in this sector after the intensive education I received.",
    skills: [
      { name: "JAVASCRIPT", src: "./icons/js-logo.png", alt: "javasctipt" },
      { name: "REACT", src: "./icons/react-logo.png", alt: "react" },
      { name: "REDUX", src: "./icons/redux-logo.png", alt: "redux" },
      { name: "NODE", src: "./icons/node-logo.png", alt: "node" },
      { name: "VSCODE", src: "./icons/vscode-logo.png", alt: "vscode" },
